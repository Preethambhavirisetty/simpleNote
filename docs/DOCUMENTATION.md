...
| Max loop/context guards | **Yes** | Executor turn caps, review/revision cycle caps, per-step tool caps, a search loop breaker, a graph recursion limit, token-budgeted context packing, and per-call deadlines. |
